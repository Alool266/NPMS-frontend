...
export default {
  setup(){
    ...
    methods: {
      ...
      //Second-level linkage between the sales department and the account manager
      //Query the customer and opportunity information of the transfer party
      searchOutCusInfo(){
      ...
      //-- Find the department name by department ID
      getDeptName(){
      ...
      //Click on the customer id to display customer details
      getCusDetail(row){
            ...
            //Click on the opportunity id to display the detailed information of the opportunity
...
//Handover (handover the customer and the corresponding opportunity at the same time)
      handover(){
