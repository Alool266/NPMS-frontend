<template>
    <div class="container" :class="{'sign-up-mode':signUpMode}">
        ...
        <!-- Switch animation left and right -->
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>Welcome to NEU opportunity management System!</h3>
                    <p>For more details you can click</p>
                    <button @click="signUpMode = !signUpMode" class="btn transparent">Know More</button>
                </div>
                <img src="@/assets/image/log.png" class="image"/>
            </div>

            <div class="panel right-panel">
                <div class="content">
                    <h3>The system is designed for NEU staff.</h3>
                    <p>Only internal registration is supported for now .</p>
...
.container:before {
  ...
  background-image: linear-gradient(-45deg, #2e405f 0%, #294149 100%);
