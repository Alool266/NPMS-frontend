    ...
    <div class="table">
        <el-table :data="tableData" border stripe style="width: 100%; margin: 1em 0"
            ...
            <el-table-column v-for="(title,t) in tableTitle" :key="t" show-overflow-tooltip
                             ...
                             :width="title.width"/>
            <el-table-column v-if="operation.flag" label="operate" align="center" width="210">
                <template #default="scope">
                    <el-button v-if="operation.detail" size="small" round @click="detail(scope.row)">Check</el-button>
                    <el-button v-if="operation.edit" type="primary" size="small" round @click="edit(scope.row)">edit</el-button>
                    <el-button v-if="operation.del" type="danger" size="small" round @click="del(scope.row)">delete</el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const del = (val) => {
                ElMessageBox.confirm('This operation will permanently delete this piece of data, do you want to continue?', 'hint', {
