        ...
        <el-aside :style="defaultHeight" :width="asideWidth">
            <el-affix :z-index="1200">
                ...
                <span :class="[isCollapse ? 'is-collapse' : '']">
                    <span class="logo-name">opportunity management system</span>
                </span>
                </div>
            </el-affix>
                    ...
                    <el-col :span="10">
                        <div class="header-breadcrumb">
                            <el-breadcrumb separator="/" v-if="this.$route.matched[0].path != '/main'">
                                <el-breadcrumb-item :to="{ path: '/' }">workbench</el-breadcrumb-item>
                                <el-breadcrumb-item v-for="(matched,m) in this.$route.matched" :key="m">
                                    {{matched.name}}
                                </el-breadcrumb-item>
                            </el-breadcrumb>
                            <el-breadcrumb separator="/" v-else>
                                <el-breadcrumb-item>workbench</el-breadcrumb-item>
                            </el-breadcrumb>
                        </div>
                    </el-col>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            onMounted(() => {
                // var target = window.sessionStorage.getItem('position')
                // console.log(target)
